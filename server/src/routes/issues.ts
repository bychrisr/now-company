...
import { addIssueInteractionRoutes } from "./issue-interactions.js";
import { addIssueAttachmentRoutes } from "./issue-attachments.js";
import { addIssueCommentRoutes } from "./issue-comments.js";
import { addIssueDocumentRoutes } from "./issue-documents.js";
...
export function issueRoutes(
  ...
  // Subdomínios extraídos (DEBT-002 Fase 2)
  addIssueInteractionRoutes(router, db, svc, heartbeat);
  addIssueDocumentRoutes(router, db, svc, documentsSvc, documentAnnotationsSvc, heartbeat, {
    assertAgentIssueMutationAllowed,
    assertDeliverableMutationAllowedByRunContext,
    revalidateActiveSourceRecoveryAfterCommittedWrite,
    logExpiredRequestConfirmations,
    summarizeIssueReferenceActivityDetails,
    summarizeIssueRelationForActivity,
  });
  addIssueCommentRoutes(router, db, svc, heartbeat, {
    assertAgentIssueMutationAllowed,
    assertExplicitResumeIntentAllowed,
    getClosedIssueExecutionWorkspace,
    respondClosedIssueExecutionWorkspace,
    cancelScheduledRetrySupersededByComment,
  ...
  addIssueAttachmentRoutes(router, db, svc, storage, heartbeat, {
    assertAgentIssueMutationAllowed,
    assertDeliverableMutationAllowedByRunContext,
  });
