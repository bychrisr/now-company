...
## Corpus Check
- Large corpus: 3661 files · ~4,816,402 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 58494 nodes · 84319 edges · 2323 communities (2271 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 577 edges (avg confidence: 0.8)
...
1. `cn()` - 375 edges
2. `useCompany()` - 157 edges
3. `companies` - 151 edges
4. `queryKeys` - 119 edges
5. `agents` - 118 edges
6. `Button` - 114 edges
7. `Db` - 113 edges
8. `Issue` - 112 edges
9. `useBreadcrumbs()` - 102 edges
10. `issues` - 101 edges

## Surprising Connections (you probably didn't know these)
- `requestJson()` --calls--> `fetch()`  [INFERRED]
  cli/src/client/board-auth.ts → packages/plugins/sandbox-providers/cloudflare/bridge-template/src/index.ts
- `getDevHealthPayload()` --calls--> `fetch()`  [INFERRED]
  scripts/dev-runner.mjs → packages/plugins/sandbox-providers/cloudflare/bridge-template/src/index.ts
- `pathExists()` --calls--> `stat`  [INFERRED]
  cli/src/commands/client/company.ts → scripts/link-plugin-dev-sdk.mjs
- `resolveInlineSourceFromPath()` --calls--> `stat`  [INFERRED]
  cli/src/commands/client/company.ts → scripts/link-plugin-dev-sdk.mjs
- `confirmOverwriteExportDirectory()` --calls--> `stat`  [INFERRED]
  cli/src/commands/client/company.ts → scripts/link-plugin-dev-sdk.mjs

## Communities (2323 total, 52 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (420): applyCreateIssueStatusDefault(), assertRequestConfirmationTargetIsCurrent(), buildIssueDocumentTargetFromSnapshot(), buildTaskCreationOrder(), expireStaleRequestConfirmationTarget(), getIssueDocumentTargetSnapshot(), hydrateInteraction(), InteractionActor (+412 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (291): useAdapterCapabilities(), useDisabledAdaptersSync(), accessApi, authApi, AuthApiError, AuthErrorBody, ApiError, companiesApi (+283 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (266): activityApi, companySkillsApi, RestoreRoutineRevisionResponse, RestoreRoutineRevisionSecretMaterial, RotateRoutineTriggerResponse, routinesApi, RoutineTriggerResponse, emptyRow() (+258 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (269): actorMiddleware(), normalizeAllowedHostnames(), privateHostnameGuard(), resolvePrivateHostnameAllowSet(), validate(), recoveryService(), accessRoutes(), activityRoutes() (+261 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (295): CompanyJoinRequest, BlockedInboxRow(), BlockedInboxRowProps, BlockedInboxView(), BlockedInboxViewProps, resolveOwnerName(), banner, blockedViewProps (+287 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (214): activityLog, agentApiKeys, agentConfigRevisions, agentMemberships, agentRuntimeState, agentTaskSessions, agentWakeupRequests, agents (+206 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (222): AdapterModelProfile, AgentHireResponse, AgentKey, agentPath(), AgentPermissionUpdate, agentsApi, AgentWakeRequest, AvailableSkill (+214 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (299): ModeBadge(), RunLivenessFields, SidebarAccountMenuProps, BaseServerInput, buildCustomServerConfig(), buildPresetServerConfig(), detectTailnetBindHost(), inferConfiguredBind() (+291 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (277): BlockedReasonChipProps, IssueChatMessageContext, IssueChatThreadProps, IssueThreadInteractionCardProps, StatusIconProps, buildSuggestedTaskTree(), collectSuggestedTaskClientKeys(), countSuggestedTaskNodes() (+269 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (277): GoalPropertiesProps, GoalNodeProps, GoalTreeProps, CapabilityCheckResult, PluginManagedAgentServiceOptions, PluginManagedSkillServiceOptions, createPluginBundlerPresets(), EsbuildLikeOptions (+269 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (211): issueRelations, main(), parseFlag(), createInviteToken(), hashToken(), main(), readArg(), getUtcMonthStart() (+203 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (179): acpxLocalUIAdapter, AdapterDisplayInfo, adapterDisplayMap, getAdapterDisplay(), getAdapterLabel(), getAdapterLabels(), getTypeSuffix(), humanizeType() (+171 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (196): ActivityRow(), entityLink(), CommentReassignment, CommentThread(), CommentThreadProps, CommentWithRunMeta, CopyMarkdownButton(), formatTimelineActorName() (+188 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (206): normalizePath(), shouldSilenceHttpSuccessLog(), SILENCED_SUCCESS_API_PATHS, SILENCED_SUCCESS_METHODS, SILENCED_SUCCESS_STATIC_PATHS, SILENCED_SUCCESS_STATIC_PREFIXES, httpLogger, logDir (+198 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (169): IssueForRun, RunForIssue, ActiveRunForIssue, LiveRunForIssue, mockApi, WatchdogDecisionInput, ActivityIssueReference, IssueReferenceActivitySummary() (+161 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (161): ImageGalleryModal(), ImageGalleryModalProps, IssuesList(), PathInstructionsModal(), WorktreeBanner(), DialogActionsContext, DialogActionsValue, DialogContextValue (+153 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (161): userProfilesApi, AccountingModelCard(), SURFACES, BillerSpendCard(), BillerSpendCardProps, BudgetIncidentCard(), centsInputValue(), incidentStateLabel() (+153 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (204): applyMergePlan(), branchExistsOnAnyRemote(), branchHasUniqueCommits(), ClosableDb, collectClaimedWorktreePorts(), collectMergePlan(), ConfiguredStorage, CopiedGitHooksResult (+196 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (161): SandboxedParser, CompanySearchParams, searchApi, GoalNode(), HermesIcon(), HermesIconProps, interactionKindLabel(), IssueThreadInteractionCard() (+153 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (168): BUILTIN_ADAPTER_TYPES, dedupeModels(), fetchOpenAiModels(), fingerprint(), listCodexModels(), loadCodexModels(), mergedWithFallback(), refreshCodexModels() (+160 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (137): AcceptInviteInput, AdminUserDirectoryEntry, AgentJoinRequestAccepted, ArchiveCompanyMemberResponse, BoardClaimStatus, CliAuthChallengeStatus, CompanyInviteCreated, CompanyInviteListResponse (+129 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (133): CompanyStats, aggregateRuns(), ChartCard(), getLast14Days(), IssueStatusChart(), PriorityChart(), priorityColors, priorityOrder (+125 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (128): acpxLocalCLIAdapter, claudeLocalCLIAdapter, codexLocalCLIAdapter, cursorCloudCLIAdapter, cursorLocalCLIAdapter, geminiLocalCLIAdapter, grokLocalCLIAdapter, openclawGatewayCLIAdapter (+120 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (136): activationEntityTypeBody(), cloudUpstreamRoutes(), stringBody(), stringQuery(), parseCostDateRange(), parseCostLimit(), pluginState, activationChecklistFromReport() (+128 more)
...
Cohesion: 0.02
Nodes (115): DocumentAnnotationListFilter, documentAnnotationsApi, ActivityRowProps, PendingAnchor, AnnotationFilter, AnnotationPanelBody(), AnnotationPanelProps, CommentRow() (+107 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (124): CodexLocalConfigFields(), codexLocalUIAdapter, main(), parseArgs(), ProbeArgs, stringifyError(), modelProfiles, models (+116 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (112): configCheck(), databaseCheck(), deploymentAuthCheck(), CheckResult, llmCheck(), logCheck(), portCheck(), storageCheck() (+104 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (112): collapseDuplicatePendingHumanJoinRequests(), findReusableHumanJoinRequest(), humanJoinRequestIdentity(), JoinRequestLike, nonEmptyTrimmed(), normalizeJoinRequestEmail(), addCompanyMemberRemovalAccess(), agentJoinGrantsFromDefaults() (+104 more)

### Community 29 - "Community 29"
Cohesion: 0.02
Nodes (111): budgetsApi, roleLabels, ScrollToBottom(), SourceResolvedFoldBadge(), SourceResolvedFoldBadgeProps, isoOrLocaleString(), issueLink(), SourceResolvedFoldCallout() (+103 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (121): ClosableDb, closeDb(), disableAllRoutinesCommand(), disableAllRoutinesInConfig(), DisableAllRoutinesResult, EmbeddedPostgresCtor, EmbeddedPostgresHandle, EmbeddedPostgresInstance (+113 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (125): simpleTextCondition(), sqlTextArray(), getDefaultCompanyGoal(), GoalReader, MaybeId, resolveIssueGoalId(), resolveNextIssueGoalId(), ACTIVE_RUN_STATUSES (+117 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (113): BudgetEnforcementScope, allowsIssueInteractionWake(), AppliedModelProfileConfigSource, applyPersistedExecutionWorkspaceConfig(), boundHeartbeatRunEventPayloadForStorage(), boundRunEventValue(), buildExplicitResumeSessionOverride(), buildPaperclipTaskMarkdown() (+105 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (114): CommandManagedRuntimeAsset, CommandManagedRuntimeSpec, createCommandManagedRuntimeClient(), mergeRuntimeExcludes(), prepareCommandManagedRuntime(), shellQuote(), calls, cleanupDirs (+106 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (125): execute(), execute(), hasNonEmptyEnvValue(), renderApiAccessNote(), execute(), firstNonEmptyLine(), execute(), __moduleDir (+117 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (116): ADAPTER_DEFAULT_RULES_BY_TYPE, AgentLike, appendCodexImportArg(), appendSkillExportDirSuffix(), applyImportAdapterRunDefaults(), applySelectedFilesToSource(), asBoolean(), asInteger() (+108 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (98): configuredWorkspaceLabel(), CopyableInline(), defaultExecutionWorkspaceModeForProject(), EXECUTION_WORKSPACE_OPTIONS, IssueWorkspaceCard(), IssueWorkspaceCardProps, projectWorkspaceDetailLink(), shouldPresentExistingWorkspaceSelection() (+90 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (99): isAutomaticRecoverySuppressedByPauseHold(), IssueTreeControlService, buildLivenessEscalationDescription(), buildLivenessOriginalIssueComment(), didAutomaticRecoveryFail(), EXECUTION_PATH_HEARTBEAT_RUN_STATUSES, formatDependencyPath(), isExhaustedSuccessfulRunHandoff() (+91 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (113): manifest, harness, issue, result, WIKI_MAINTAINER_SKILL_CANONICAL_KEY, WIKI_MAINTENANCE_ROUTINE_KEYS, WIKI_MANAGED_SKILL_CANONICAL_KEYS, WIKI_MANAGED_SKILL_KEYS (+105 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (91): healthRoutes(), companyMemberships, instanceUserRoles, PackageJson, pkg, require, GrantInput, MemberArchiveInput (+83 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (97): AnnotationLayerProps, AnnotationOverlayThread, clearNativeHighlightRanges(), clipsOverflow(), CssHighlight, DocumentAnnotationLayer(), elementFromNode(), getNativeHighlightApi() (+89 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (100): installSkillsForTarget(), resolveDesiredSkillKeys(), appendExcerpt(), applyRunScopedMentionedSkillKeys(), COMMAND_CLI_SECRET_OPTION_RE, COMMAND_ENV_SECRET_ASSIGNMENT_RE, COMMAND_SECRET_HINTS, maybeContainsSecretText() (+92 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (87): attachErrorContext(), ErrorContext, errorHandler(), shouldExposeTrustedCloudTenantImportError(), HttpError, baseUser, createApp(), createDb() (+79 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (91): printAssistantMessage(), printCursorStreamEvent(), printLegacyToolEvent(), printToolCallEventTopLevel(), printUserMessage(), asNumber(), asRecord(), asString() (+83 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (101): affectedPagePathsFromRunMetadata(), appendBoundedSection(), assemblePaperclipSourceBundle(), assertRequestedCharacterLimit(), assertSourceWithinConfiguredLimit(), BootstrapInput, buildQueryPrompt(), byteLength() (+93 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (81): ActivityListOptions, registerActivityCommands(), AgentListOptions, AgentLocalCliOptions, CreatedAgentKey, __moduleDir, registerAgentCommands(), SkillsInstallSummary (+73 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (94): issueRecoveryActions, appendNote(), asBoolean(), asNumber(), asRecord(), asString(), buildAgentContext(), buildClaudeTraceFiles() (+86 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (82): asRecord(), assertCloudSyncEnabled(), assertDiscoveryCompatible(), authorizeConnection(), authorizeWithBrowser(), authorizeWithDeviceCode(), buildBundleFromLocalCompany(), buildEntitiesFromPortableExport() (+74 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (79): getWorkspaceSpecificRoutineVariableNames(), routineHasWorkspaceSpecificVariables(), routine, WORKSPACE_SPECIFIC_ROUTINE_VARIABLES, ActorInput, commentSelect, IssueDocumentRow, threadSelect (+71 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (79): modelProfiles, models, alternateWorkspaceDir, call, cleanupDirs, dir, {
  runChildProcess,
...
}, workspaceDir (+71 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (77): actionChip(), appendMessageBlock(), appendPreviewExamples(), assertDeleteConfirmation(), buildCompanyDashboardUrl(), buildDefaultImportAdapterMessages(), buildDefaultImportAdapterOverrides(), buildDefaultImportSelectionState() (+69 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (69): DefaultLauncherTrigger(), entityScopedZones, focusableElementSelector, getErrorMessage(), launcherDisplayName(), LauncherErrorBoundary, LauncherErrorBoundaryProps, LauncherErrorBoundaryState (+61 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (86): activityIssueId, advancedIssueIds, agentId, anchorCommentId, archivedIssueId, assignedIssueId, assigneeAgentId, assigneeEnvironmentId (+78 more)

### Community 53 - "Community 53"
Cohesion: 0.03
Nodes (60): BetterAuthInstance, BetterAuthSessionResult, BetterAuthSessionUser, buildBetterAuthAdvancedOptions(), createBetterAuthHandler(), createBetterAuthInstance(), deriveAuthCookiePrefix(), deriveAuthTrustedOrigins() (+52 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (66): RunCardRecoveryChip(), CommentCard(), BlockerRecoveryIndicator(), IssueBlockedNotice(), SuccessfulRunRetryNowControl(), baseRetry, button, indicator (+58 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (73): toSafeSlug(), uniqueNameBySlug(), asString(), buildSkillRuntimeName(), classifyInventoryKind(), collectLocalSkillInventory(), CompanySkillListDbRow, CompanySkillListRow (+65 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (75): collectEnvLabDoctorStatus(), envLabDoctorCommand(), envLabDownCommand(), envLabStatusCommand(), envLabUpCommand(), printJson(), registerEnvLabCommands(), resolveEnvLabSshStatePath() (+67 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (76): WorkspaceOperationRecorder, allocatePort(), buildExecutionWorkspaceCleanupEnv(), buildTemplateData(), buildWorkspaceCommandEnv(), buildWorkspaceReadyComment(), cleanupExecutionWorkspaceArtifacts(), detectDefaultBranch() (+68 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (71): dbBackupCommand(), DbBackupOptions, normalizeRetentionDays(), resolveBackupDir(), resolveConnectionString(), asPositiveInt(), createBufferedTextFileWriter(), ExtensionDefinition (+63 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (78): activeIncidents, activeIncidentsDescription, activeIncidentsSection, activeIncidentsSectionDescription, agentBudgetDescription, agentBudgets, agentsPaused, allBillers (+70 more)
...
Cohesion: 0.05
Nodes (59): modelProfiles, models, alternateWorkspaceDir, call, cleanupDirs, dir, {
  runChildProcess,
  ensureCommandResolvable,
  resolveCommandForLogs,
  prepareWorkspaceForSshExecution,
  ...
  syncDirectoryToSsh,
  startAdapterExecutionTargetPaperclipBridge,
}, workspaceDir (+51 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (61): addAgentChainCandidates(), addOwnerCandidate(), BLOCKING_AGENT_STATUSES, classifyIssueGraphLiveness(), finding(), hasScheduledMonitor(), incidentKey(), INVOKABLE_AGENT_STATUSES (+53 more)
...
Cohesion: 0.05
Nodes (74): ActionBar, ActionBarItem, ActionBarProps, AssigneePicker, AssigneePickerProps, AssigneePickerSelection, DataTable, DataTableColumn (+66 more)

### Community 102 - "Community 102"
Cohesion: 0.03
Nodes (66): canStopIssueChatRun(), acceptButton, { appendMock }, attachmentList, cancelButton, {
  captureComposerViewportSnapshotMock,
  restoreComposerViewportSnapshotMock,
  shouldPreserveComposerViewportMock,
}, childCheckbox, comments (+58 more)

### Community 103 - "Community 103"
Cohesion: 0.04
Nodes (52): allowedPatterns, DEFAULT_ALLOWED_TYPES, INLINE_ATTACHMENT_TYPES, isAllowedContentType(), isInlineAttachmentContentType(), matchesContentType(), normalizeContentType(), normalizeIssueAttachmentMaxBytes() (+44 more)

### Community 104 - "Community 104"
Cohesion: 0.04
Nodes (54): SuccessfulRunHandoffCommentCallout(), Agent, KANBAN_COLD_STATUSES, KANBAN_COLUMN_PAGE_SIZE_OPTIONS, KanbanBoard(), KanbanBoardProps, KanbanCard(), KanbanColumn() (+46 more)

### Community 105 - "Community 105"
Cohesion: 0.04
Nodes (57): confirmButton, declineButton, enabledSaveButton, host, jumpLink, multiGroup, onAcceptInteraction, onRejectInteraction (+49 more)

### Community 106 - "Community 106"
Cohesion: 0.05
Nodes (53): models, ctx, logs, tempRoots, __moduleDir, pathExists(), renderPaperclipEnvNote(), sessionCodec (+45 more)

### Community 107 - "Community 107"
Cohesion: 0.04
Nodes (58): cloudUpstreamsApi, act(), activateButton, connectButton, flushReact(), input, mockCloudUpstreamsApi, mockCompanyState (+50 more)
...
Cohesion: 0.03
Nodes (66): actor, actualHead, agentId, baseInput, baseRoot, captured, companyId, config (+58 more)

### Community 110 - "Community 110"
Cohesion: 0.03
Nodes (58): AgentRow, AssetRow, buildWorktreeMergePlan(), CommentMergeAction, CommentRow, compareIssueCoreFields(), DocumentRevisionRow, DocumentRevisionTableRow (+50 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (65): hasExecutionParticipant(), hasScheduledMonitor(), summarizeIssueMonitor(), ActorLike, actorPrincipal(), applyIssueExecutionPolicyTransition(), applyIssueExecutionStageTransition(), applyMonitorTransition() (+57 more)

### Community 112 - "Community 112"
Cohesion: 0.06
Nodes (53): modelProfiles, models, alternateWorkspaceDir, call, cleanupDirs, dir, {
  runChildProcess,
  ensureCommandResolvable,
  resolveCommandForLogs,
  prepareWorkspaceForSshExecution,
  ...
  syncDirectoryToSsh,
  startAdapterExecutionTargetPaperclipBridge,
}, workspaceDir (+45 more)

### Community 113 - "Community 113"
Cohesion: 0.03
Nodes (59): alphaIssue, assignedIssue, backlogIssue, backlogIssues, betaIssue, blockedIssue, blockerButtons, button (+51 more)

### Community 114 - "Community 114"
Cohesion: 0.07
Nodes (60): plugin, stringField(), buildManualDistillPrompt(), ManagedRoutineDefaultDrift, ManagedRoutineSettingsResolution, manualDistillScopeLabel(), normalizeRoutineTemplateText(), PAPERCLIP_EVENT_INGESTION_EVENTS (+52 more)

### Community 115 - "Community 115"
Cohesion: 0.07
Nodes (59): execute, __moduleDir, normalizeMode(), pathExists(), AcpxExecutionPhase, AcpxPreparedRuntime, AcpxRuntimeFactory, applySessionConfigOptions() (+51 more)

### Community 116 - "Community 116"
Cohesion: 0.08
Nodes (46): BridgeExecuteParams, buildLoginShellScript(), coerceExecuteResult(), executeInSandbox(), isValidShellEnvKey(), randomToken(), deleteFile, exec (+38 more)

### Community 117 - "Community 117"
Cohesion: 0.04
Nodes (47): activeHold, activePauseHoldState, applyResumeButton, bodyScrollRegion, cancelApplyButton, cancelHold, cancelMenuButton, chatPauseButton (+39 more)
...
Cohesion: 0.05
Nodes (48): confirmOverwriteExportDirectory(), pathExists(), asRecord(), buildFeedbackTraceQuery(), buildFeedbackVoteRecord(), collectJsonFilesForArchive(), compactText(), crc32() (+40 more)
...
Cohesion: 0.05
Nodes (49): BlockedReasonChip(), IconComponent, SEVERITY_DOT, cases, chip, classy, dot, local (+41 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (39): ABC, Anthropic, Any, str, Any, int, Path, str (+31 more)

### Community 123 - "Community 123"
Cohesion: 0.05
Nodes (31): companySearchBranchFetchLimit(), companySearchService(), createSnippet(), extractFirstImageUrl(), findFirstMatchIndex(), highlightRanges(), iso(), issueHref() (+23 more)

### Community 124 - "Community 124"
Cohesion: 0.06
Nodes (45): buildPluginInitNextCommands(), buildPluginInitScaffoldOptions(), buildPluginInstallRequest(), expandHomePath(), hasLocalPathSyntax(), isExistingRelativePath(), packageToDirName(), PluginInitOptions (+37 more)

### Community 125 - "Community 125"
Cohesion: 0.08
Nodes (33): initTelemetry(), PackageJson, pkg, require, initTelemetry(), initTelemetryFromConfigFile(), DEFAULT_ENDPOINTS, TelemetryClient (+25 more)

### Community 126 - "Community 126"
Cohesion: 0.06
Nodes (43): resolveEnvironmentExecutionTarget(), resolveEnvironmentExecutionTransport(), EnvironmentAcquisitionResult, EnvironmentErrorCode, EnvironmentRealizationResult, EnvironmentReleaseResult, EnvironmentRunError, firstNonEmptyLine() (+35 more)

### Community 127 - "Community 127"
Cohesion: 0.04
Nodes (50): name, notNull, primaryKey, type, adapter_type, last_error, last_run_id, last_run_status (+42 more)
...
Cohesion: 0.08
Nodes (41): BudgetServiceHooks, computeObservedAmount(), currentUtcMonthWindow(), IncidentRow, PolicyRow, resolveScopeRecord(), resolveWindow(), ScopeRecord (+33 more)

### Community 132 - "Community 132"
Cohesion: 0.08
Nodes (39): collectEnvironmentSecretRefs(), getSandboxProviderConfigSchema(), parseEnvironmentDriverConfig(), resolveEnvironmentDriverConfigForRuntime(), probeEnvironment(), createLocalEnvironmentDriver(), createPluginEnvironmentDriver(), createSandboxEnvironmentDriver() (+31 more)
...
Cohesion: 0.06
Nodes (42): pluginDatabaseNamespaces, pluginMigrations, ApplyPluginMigrationsOptions, assertAllowedPublicRead(), assertIdentifier(), assertNoBannedSql(), derivePluginDatabaseNamespace(), extractQualifiedRefs() (+34 more)
...
Cohesion: 0.06
Nodes (42): ToastInput, hasCompanyPrefix(), HostLocation, HostNavigation, HostNavigationLinkOptions, HostNavigationLinkProps, HostNavigationOptions, isPlainLeftClick() (+34 more)

### Community 138 - "Community 138"
Cohesion: 0.04
Nodes (48): scripts, build, build:npm, build-storybook, check:tokens, db:backup, db:generate, db:migrate (+40 more)

### Community 139 - "Community 139"
Cohesion: 0.07
Nodes (46): BIND_MODES, BindMode, consumeDevServerRestartRequest(), devServerRestartRequestFilePath, devService, addFileToSnapshot(), buildPluginSdk(), clearDevIntervals() (+38 more)

### Community 140 - "Community 140"
Cohesion: 0.04
Nodes (47): name, notNull, primaryKey, type, claimed_at, error, finished_at, idempotency_key (+39 more)

### Community 141 - "Community 141"
Cohesion: 0.05
Nodes (36): activityDetailsText, agentId, blockedAssigneeAgentId, blockedIssueId, blockerIssueId, child, childProcesses, cleanupPids (+28 more)

### Community 142 - "Community 142"
Cohesion: 0.07
Nodes (35): buildPortableAgentSlugMap(), buildPortableProjectSlugMap(), buildPortableSidebarOrder(), alphaOne, alphaTwo, beta, launch, launchTwo (+27 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (43): addFileToSnapshot(), buildPluginSdk(), clearDevIntervals(), clearDevServerStatus(), cliArgs, collectWatchedSnapshot(), devServerStatusFilePath, diffSnapshots() (+35 more)

### Community 144 - "Community 144"
Cohesion: 0.05
Nodes (39): crc32(), createStoredZipArchive(), writeUint16(), writeUint32(), child, cliContext, createBasePaperclipEnv(), createCliEnv() (+31 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (45): CompanyUserDirectoryResponse, AGENT_TOAST_STATUSES, buildActivityToast(), buildAgentStatusToast(), buildIssueRefsForPayload(), buildJoinRequestToast(), buildRunStatusToast(), closeSocketQuietly() (+37 more)

### Community 146 - "Community 146"
Cohesion: 0.04
Nodes (46): last_error, last_run_status, session_id, state_json, total_cached_input_tokens, total_cost_cents, total_input_tokens, total_output_tokens (+38 more)

### Community 147 - "Community 147"
Cohesion: 0.06
Nodes (40): FinanceKindCardProps, FinanceTimelineCardProps, editButton, mockAccessApi, mockAssetsApi, mockCompaniesApi, mockEnvironmentsApi, mockInstanceSettingsApi (+32 more)

### Community 148 - "Community 148"
Cohesion: 0.04
Nodes (45): last_error, last_run_id, last_run_status, session_id, state_json, total_cached_input_tokens, total_cost_cents, total_input_tokens (+37 more)

### Community 149 - "Community 149"
Cohesion: 0.04
Nodes (45): name, notNull, primaryKey, type, adapter_type, last_run_id, last_run_status, session_id (+37 more)

### Community 150 - "Community 150"
Cohesion: 0.04
Nodes (45): name, notNull, primaryKey, type, adapter_type, last_error, last_run_id, session_id (+37 more)

### Community 151 - "Community 151"
Cohesion: 0.07
Nodes (40): cloneRecord(), execFileAsync, ExecutionWorkspaceRow, inspectGitCloseReadiness(), isRecord(), loadEffectiveRuntimeServicesByExecutionWorkspace(), mergeExecutionWorkspaceConfig(), pathExists() (+32 more)

### Community 152 - "Community 152"
Cohesion: 0.09
Nodes (41): WorkspaceDiffCaps, WorkspaceDiffPatchKind, WorkspaceDiffWarningCode, addStatusEntries(), buildTrackedPatch(), buildUntrackedFilePatch(), buildUntrackedPatch(), collectFiles() (+33 more)

### Community 153 - "Community 153"
Cohesion: 0.05
Nodes (38): addButton, addLabelButton, blockerLink, bugButton, candidateButton, clearButton, clearParentButton, confirmButton (+30 more)

### Community 154 - "Community 154"
Cohesion: 0.06
Nodes (31): manifest, ephemeral, mockCreate, reusable, sandbox, warnSpy, buildLoginShellScript(), createSandbox() (+23 more)
...
Cohesion: 0.05
Nodes (44): name, notNull, primaryKey, type, adapter_type, last_error, last_run_id, last_run_status (+36 more)
...
Cohesion: 0.08
Nodes (42): fetchBinary(), fetchJson(), fetchOptionalText(), fetchText(), normalizeGitHubSourcePath(), parseGitHubSourceUrl(), fetchJson(), fetchText() (+34 more)

### Community 159 - "Community 159"
Cohesion: 0.05
Nodes (37): logs, tempRoots, workspaceDir, additionalDirectories, baseConfig, codexHome, cwd, envFileNames (+29 more)

### Community 160 - "Community 160"
Cohesion: 0.07
Nodes (41): applyRuntimePortSelectionToConfig(), buildIsolatedWorktreeConfig(), collectSiblingWorktreePorts(), expandHomePrefix(), findNextUnclaimedPort(), formatEnvEntries(), isPathInside(), maybePersistWorktreeRuntimePorts() (+33 more)
...
Cohesion: 0.05
Nodes (43): name, notNull, primaryKey, type, claimed_at, error, finished_at, idempotency_key (+35 more)

### Community 163 - "Community 163"
Cohesion: 0.05
Nodes (43): name, notNull, primaryKey, type, default, name, notNull, primaryKey (+35 more)
...
Cohesion: 0.05
Nodes (43): default, name, notNull, primaryKey, type, coalesced_count, idempotency_key, payload (+35 more)
...
Cohesion: 0.05
Nodes (42): name, notNull, primaryKey, type, default, name, notNull, primaryKey (+34 more)
...
Cohesion: 0.05
Nodes (42): company_id, id, key_hash, last_used_at, name, role, title, name (+34 more)
...
Cohesion: 0.06
Nodes (37): formatErrorResponse(), formatTextResponse(), McpTextResponse, addCommentToolSchema, agentIdOptional, apiRequestSchema, approvalDecisionSchema, approvalIdSchema (+29 more)

### Community 175 - "Community 175"
Cohesion: 0.08
Nodes (35): resolveDefaultBackupDir(), resolveDefaultEmbeddedPostgresDir(), resolveDefaultLogsDir(), resolveDefaultSecretsKeyFilePath(), resolveDefaultStorageDir(), expandHomePrefix(), resolveHomeAwarePath(), resolvePaperclipConfigPathForInstance() (+27 more)
...
Cohesion: 0.10
Nodes (31): AcquireSandboxLeaseInput, acquireSandboxProviderLease(), assertProviderConfig(), buildFakeSandboxProbe(), DestroySandboxLeaseInput, destroySandboxProviderLease(), FakeSandboxProvider, findReusableSandboxProviderLeaseId() (+23 more)
...
Cohesion: 0.05
Nodes (40): last_run_id, last_run_status, session_id, total_cached_input_tokens, total_cost_cents, total_input_tokens, total_output_tokens, name (+32 more)
...
Cohesion: 0.08
Nodes (37): applyLocalQueuedIssueCommentState(), applyOptimisticIssueCommentUpdate(), applyOptimisticIssueFieldUpdate(), applyOptimisticIssueFieldUpdateToCollection(), createOptimisticCommentId(), createOptimisticIssueComment(), flattenIssueCommentPages(), getNextIssueCommentPageParam() (+29 more)
...
Cohesion: 0.11
Nodes (35): authorNameForComment(), buildAssistantPartsFromTranscript(), buildIssueChatMessages(), compactIssueChatTranscript(), computeSegmentTimings(), createAssistantMetadata(), createCommentMessage(), createHistoricalRunMessage() (+27 more)

### Community 197 - "Community 197"
Cohesion: 0.05
Nodes (38): name, notNull, primaryKey, type, name, notNull, primaryKey, type (+30 more)
...
Cohesion: 0.05
Nodes (38): company_id, created_at, id, key_hash, last_used_at, name, revoked_at, name (+30 more)
...
Cohesion: 0.10
Nodes (29): sessionCodec, dedupeModels(), discoveryCache, discoveryCacheKey(), firstNonEmptyLine(), normalizeEnv(), pruneExpiredDiscoveryCache(), sortModels() (+21 more)

### Community 304 - "Community 304"
Cohesion: 0.09
Nodes (35): ctx, asRecord(), execute(), firstNonEmptyLine(), renderPaperclipEnvNote(), asStringEnvMap(), buildAgentOptions(), buildInstructionsPrefix() (+27 more)
...
Cohesion: 0.09
Nodes (33): AgentInstructionsBundle, AgentInstructionsFileDetail, AgentInstructionsFileSummary, AgentLike, applyBundleConfig(), asRecord(), asString(), buildPersistedBundleConfig() (+25 more)
...
Cohesion: 0.09
Nodes (32): base64ToBytes(), binaryContentTypeByExtension, bytesToBase64(), bytesToPortableFileEntry(), concatChunks(), crc32(), crcTable, createZipArchive() (+24 more)
...
Cohesion: 0.05
Nodes (37): name, notNull, primaryKey, type, agent_id, company_id, id, key_hash (+29 more)
...
Cohesion: 0.06
Nodes (36): decided_at, decided_by_user_id, decision_note, payload, requested_by_agent_id, requested_by_user_id, type, name (+28 more)
...
Cohesion: 0.09
Nodes (27): isPlainObject(), redactDetectedSuccessfulRunProgressSummaryForBoard(), createLocalFileWorkspaceOperationLogStore(), getWorkspaceOperationLogStore(), WorkspaceOperationLogFinalizeSummary, WorkspaceOperationLogHandle, WorkspaceOperationLogReadOptions, WorkspaceOperationLogReadResult (+19 more)
...
Cohesion: 0.11
Nodes (32): actionabilityText(), classifyRunActionability(), classifyRunLiveness(), combinedOutput(), declaredBlocker(), DEFAULT_EVIDENCE, evidenceReason(), extractNextAction() (+24 more)

### Community 382 - "Community 382"
Cohesion: 0.09
Nodes (20): bool, int, Path, str, ArchitectureValidator, main(), Check for architectural diagrams, Check that components are documented (+12 more)
...
Cohesion: 0.09
Nodes (23): buildErrorMessage(), isWriteMethod(), JsonRequestOptions, PaperclipApiClient, PaperclipApiError, parseResponseBody(), nonEmpty(), normalizeApiUrl() (+15 more)

### Community 385 - "Community 385"
Cohesion: 0.06
Nodes (35): name, notNull, primaryKey, type, adapter_type, last_error, session_display_id, session_params_json (+27 more)
...
Cohesion: 0.06
Nodes (30): agentContext, bundle, claudeRoot, commentId, companyId, filePaths, firstTrace, flushingSvc (+22 more)
...
Cohesion: 0.07
Nodes (27): manifest, ephemeral, mockCreate, reusable, sandbox, warnSpy, buildLoginShellScript(), createSandbox() (+19 more)

### Community 442 - "Community 442"
Cohesion: 0.06
Nodes (28): act(), agentMap, anchor, chip, composer, cta, directRequestButton, doc (+20 more)

### Community 443 - "Community 443"
Cohesion: 0.07
Nodes (33): act(), bodyScrollRegion, companyState, description, descriptionInput, dialogContent, dialogContentState, dialogState (+25 more)

### Community 444 - "Community 444"
Cohesion: 0.06
Nodes (34): last_run_id, last_run_status, session_id, state_json, total_input_tokens, total_output_tokens, name, notNull (+26 more)
...
Cohesion: 0.08
Nodes (29): FEEDBACK_DATA_SHARING_PREFERENCES, FEEDBACK_TARGET_TYPES, FEEDBACK_TRACE_STATUSES, FEEDBACK_VOTE_VALUES, FeedbackTargetType, FeedbackTraceBundleCaptureStatus, FeedbackTraceBundleFile, FeedbackTraceStatus (+21 more)

### Community 496 - "Community 496"
Cohesion: 0.06
Nodes (29): computeMentionMenuPosition(), findClosestAutocompleteAnchor(), isSameAutocompleteSession(), placeCaretAfterMentionAnchor(), shouldAcceptAutocompleteKey(), editable, flush(), found (+21 more)

### Community 497 - "Community 497"
Cohesion: 0.11
Nodes (30): readBrandedStaticIndexHtml(), applyUiBranding(), createFaviconDataUrl(), DEFAULT_FAVICON_LINKS, deriveColorFromSeed(), escapeHtmlAttribute(), getWorktreeUiBranding(), hexToRgb() (+22 more)

### Community 498 - "Community 498"
Cohesion: 0.11
Nodes (29): BridgeClientHeaders, BridgeClientOptions, BridgeErrorBody, BridgeExecuteOptions, buildHeaders(), consumeExecuteEventStream(), isRecord(), ParsedSseEvent (+21 more)

### Community 499 - "Community 499"
Cohesion: 0.06
Nodes (32): bin, create-paperclip-plugin, bugs, url, dependencies, @paperclipai/plugin-sdk, devDependencies, @types/node (+24 more)

### Community 500 - "Community 500"
Cohesion: 0.06
Nodes (33): action, subtitle, title_one, title_other, issuesByPriority, issuesByStatus, last14Days, runActivity (+25 more)

### Community 501 - "Community 501"
Cohesion: 0.07
Nodes (28): adapterRoutes(), app, createAdapter(), createApp(), installApp, installedRecord(), instanceAdmin, mocks (+20 more)

### Community 502 - "Community 502"
Cohesion: 0.06
Nodes (26): after, before, binDir, capture, capture1, capture2, captured, capturedNotes (+18 more)

### Community 503 - "Community 503"
Cohesion: 0.11
Nodes (18): int, Path, str, main(), Infer severity from risk name/description, Find documents that might contain mitigations, Extract mitigations from document, Match identified risks to mitigations (+10 more)
...
Cohesion: 0.06
Nodes (32): name, notNull, primaryKey, type, agent_id, created_at, key_hash, last_used_at (+24 more)
...
Cohesion: 0.06
Nodes (32): name, notNull, primaryKey, type, agent_id, id, key_hash, last_used_at (+24 more)
...
Cohesion: 0.07
Nodes (31): bugs, url, dependencies, zod, devDependencies, typescript, exports, ./telemetry (+23 more)

### Community 513 - "Community 513"
Cohesion: 0.06
Nodes (28): binDir, capture, capturePath, CapturePayload, commandNotes, commandPath, executorCapture, executorCapturePath (+20 more)

### Community 514 - "Community 514"
Cohesion: 0.10
Nodes (20): ApiClientOptions, ApiConnectionError, ApiRequestError, buildConnectionErrorMessage(), buildHealthCheckUrl(), buildUrl(), formatConnectionCause(), PaperclipApiClient (+12 more)

### Community 515 - "Community 515"
Cohesion: 0.06
Nodes (31): hint, label, alreadyArchived, archiving, button, confirm, description, failed (+23 more)
...
Cohesion: 0.06
Nodes (18): codexHome, compatibleParams, context, execute, FakeRuntime, firstExecute, LogEntry, logs (+10 more)

### Community 555 - "Community 555"
Cohesion: 0.06
Nodes (31): company_id, id, name, role, title, name, notNull, primaryKey (+23 more)

### Community 556 - "Community 556"
Cohesion: 0.09
Nodes (31): appendProjectLogContents(), assertExpectedHash(), assertPagePath(), assertPageWriteAllowed(), assertRawPath(), assertWikiPath(), autoApplyEnabled(), bootstrapSpaceFiles() (+23 more)

### Community 557 - "Community 557"
Cohesion: 0.09
Nodes (21): fileName(), html, buttonClass(), ChangesTab(), clampFileSidebarWidth(), CollapsedFilePanel(), DiffViewMode, ErrorState() (+13 more)

### Community 558 - "Community 558"
Cohesion: 0.12
Nodes (18): bool, int, Path, str, CouplingChecker, CouplingViolation, main(), Find all files to scan for coupling violations (+10 more)

### Community 559 - "Community 559"
Cohesion: 0.08
Nodes (24): applyMention(), autocompleteMarkdown(), AutocompleteOption, CaretRect, CODE_BLOCK_LANGUAGES, convertHtmlImagesToMarkdown(), detectMention(), FALLBACK_CODE_BLOCK_DESCRIPTOR (+16 more)
...
Cohesion: 0.07
Nodes (30): heartbeats, instanceSettings, hint, label, hint, label, breadcrumbs, profileSettings (+22 more)
...
Cohesion: 0.07
Nodes (30): default, name, notNull, primaryKey, type, budget_monthly_cents, description, spent_monthly_cents (+22 more)

### Community 601 - "Community 601"
Cohesion: 0.09
Nodes (27): WorkspaceDiffFilePatch, WorkspaceDiffWarning, buildFilePatch(), buildFilePatches(), DiffFileViewModel, DiffPatchViewModel, DiffRenderMode, diffSummary() (+19 more)

### Community 602 - "Community 602"
Cohesion: 0.15
Nodes (26): createDevServiceIdentity(), repoRoot, terminateHeartbeatRunProcess(), createLocalServiceKey(), execFileAsync, findAdoptableLocalService(), findLocalServiceRegistryRecordByRuntimeServiceId(), getRuntimeServiceRegistryPath() (+18 more)
...
Cohesion: 0.07
Nodes (27): accessSvc, agentInstructionsSvc, agentResult, agentSvc, assetSvc, companySkills, companySkillSvc, companySvc (+19 more)

### Community 605 - "Community 605"
Cohesion: 0.07
Nodes (29): one, other, agent_one, agent_other, confirmDisableAll, description, disableAll, disableAllError (+21 more)
...
Cohesion: 0.07
Nodes (29): company_id, created_at, state, updated_at, user_id, name, notNull, primaryKey (+21 more)
...
Cohesion: 0.09
Nodes (12): release-lib.sh script, git_remote_exists(), npm_package_version_exists(), release_fail(), release_info(), release_warn(), require_clean_worktree(), require_npm_publish_auth() (+4 more)

### Community 651 - "Community 651"
Cohesion: 0.12
Nodes (23): atMinute(), baseTime, createComment(), issueChatLongThreadAgentMap, issueChatLongThreadComments, issueChatLongThreadEvents, issueChatLongThreadFixtureContext, issueChatLongThreadLinkedRuns (+15 more)
...
Cohesion: 0.07
Nodes (23): issue, metadata, mockAccessService, mockAgentService, mockDb, mockDbSelect, mockDbSelectFrom, mockDbSelectOrderBy (+15 more)

### Community 655 - "Community 655"
Cohesion: 0.15
Nodes (26): safeMarkdownUrlTransform(), autocompleteOptionMatchesLink(), mentionMarkdown(), parseMentionChipHref(), buildAgentMentionHref(), buildProjectMentionHref(), buildSkillMentionHref(), buildUserMentionHref() (+18 more)

### Community 656 - "Community 656"
Cohesion: 0.10
Nodes (14): manifest, plugin, CloudflareBridgeError, createCloudflareBridgeClient(), isLocalBridgeHost(), LOCALHOST_HOSTNAMES, parseCloudflareDriverConfig(), readBoolean() (+6 more)

### Community 657 - "Community 657"
Cohesion: 0.08
Nodes (22): blankLatestDocument, createIssue(), createIssueDocument(), currentDocument, currentRevisionButton, document, heading, historicalRevisionButton (+14 more)

### Community 658 - "Community 658"
Cohesion: 0.07
Nodes (27): name, notNull, primaryKey, type, agent_id, created_at, key_hash, last_used_at (+19 more)
...
Cohesion: 0.07
Nodes (25): allowed, approvedAgent, baseAgent, createDbStub(), mockAccessService, mockAgentInstructionsService, mockAgentService, mockApprovalService (+17 more)

### Community 661 - "Community 661"
Cohesion: 0.10
Nodes (23): act(), betaPauseItem, browseLink, budgetPausedItem, chooseSortMode(), editLink, flushReact(), leaveItem (+15 more)

### Community 662 - "Community 662"
Cohesion: 0.08
Nodes (26): name, notNull, primaryKey, type, agent_id, goal_id, id, issue_id (+18 more)

### Community 663 - "Community 663"
Cohesion: 0.08
Nodes (26): company_id, key_hash, last_used_at, name, revoked_at, name, notNull, primaryKey (+18 more)

### Community 664 - "Community 664"
Cohesion: 0.09
Nodes (24): assertAuthenticated(), assertBoard(), assertCompanyAccess(), assertInstanceAdmin(), baseAgent, baseKey, createApp(), crossTenantActor (+16 more)

### Community 665 - "Community 665"
Cohesion: 0.14
Nodes (17): printCursorCloudEvent(), config, parseEnvBindings(), parseEnvVars(), line, asRecord(), asString(), parseAssistantMessage() (+9 more)

### Community 666 - "Community 666"
Cohesion: 0.15
Nodes (21): BoardAuthCredential, BoardAuthStore, ChallengeStatusResponse, CreateChallengeResponse, defaultBoardAuthStore(), loginBoardCli(), normalizeApiBase(), openUrl() (+13 more)

### Community 667 - "Community 667"
Cohesion: 0.19
Nodes (23): collectInternalDependencyProblemEntries(), collectInternalDependencyProblems(), collectInternalDependencyVersions(), createExitError(), createManifestLookupKey(), createProblem(), createRegistryUrl(), fetchPackageDocument() (+15 more)
...
Cohesion: 0.08
Nodes (25): columnsFrom, columnsTo, name, tableFrom, tableTo, columns, concurrently, isUnique (+17 more)
...
Cohesion: 0.16
Nodes (19): config, parseCommaArgs(), parseEnvBindings(), parseEnvVars(), parseJsonObject(), completed, asNumber(), asRecord() (+11 more)
...
Cohesion: 0.13
Nodes (21): additionalSerializedServerTests, fail(), generalGroupNames, generalWorkspacesAProjects, generalWorkspacesBProjects, nonServerProjects, options, parseCliOptions() (+13 more)

### Community 799 - "Community 799"
Cohesion: 0.11
Nodes (20): queryBooleanSchema, workspaceDiffCapsSchema, WorkspaceDiffFile, workspaceDiffFilePatchSchema, workspaceDiffFileSchema, WorkspaceDiffFileStatus, workspaceDiffFileStatusSchema, workspaceDiffPatchKindSchema (+12 more)
...
Cohesion: 0.12
Nodes (21): act(), browseLink, chooseSortMode(), curatedOrder, flushReact(), leaveItem, mockAuthApi, mockOpenNewProject (+13 more)

### Community 802 - "Community 802"
Cohesion: 0.13
Nodes (21): createSdkUiComponent(), useHostContext(), useHostLocation(), useHostNavigation(), usePluginAction(), usePluginData(), usePluginStream(), usePluginToast() (+13 more)

### Community 803 - "Community 803"
Cohesion: 0.09
Nodes (23): columns, concurrently, isUnique, method, name, with, columns, concurrently (+15 more)
...
Cohesion: 0.20
Nodes (19): parseCommaArgs(), parseEnvBindings(), parseEnvVars(), entries, line, asNumber(), asRecord(), asString() (+11 more)
...
Cohesion: 0.13
Nodes (23): agentDetails(), agentResource(), bindingTable(), bootstrapWikiRoot(), getOverview(), getResourceBinding(), parseBindingMetadata(), projectDetails() (+15 more)
...
Cohesion: 0.09
Nodes (17): stabilizeThreadMessages(), agentMap, baseMs, cancelledMessages, comments, firstPass, firstStable, linkedRuns (+9 more)

### Community 990 - "Community 990"
Cohesion: 0.21
Nodes (21): asRecord(), compactWhitespace(), describeToolInput(), displayToolName(), formatToolPayload(), formatUnknown(), humanizeLabel(), isCommandTool() (+13 more)

### Community 991 - "Community 991"
Cohesion: 0.09
Nodes (17): enabledDetailTabFilters, mockAgentsApi, mockExecutionWorkspacesApi, mockHeartbeatsApi, mockIssuesApi, mockNavigate, mockPluginSlotMount, mockPluginSlotOutlet (+9 more)

### Community 992 - "Community 992"
Cohesion: 0.09
Nodes (22): action, subtitle, title_one, title_other, issuesByPriority, issuesByStatus, last14Days, runActivity (+14 more)
...
Cohesion: 0.10
Nodes (20): workspaceDir, agentPath, buildFakeAgentScript(), buildInstallSimulationCommand(), captureDir, homeDir, managedCaptureDir, preferredCommandPath (+12 more)
...
Cohesion: 0.12
Nodes (22): import, types, import, types, exports, ./bundlers, ./dev-server, ./protocol (+14 more)
...
Cohesion: 0.11
Nodes (21): actual, compareButton, confirmButtons, createRevision(), createRoutine(), current, env, flush() (+13 more)

### Community 1105 - "Community 1105"
Cohesion: 0.09
Nodes (18): approvalInput, db, mockAccessService, mockAdapter, mockAgentInstructionsService, mockAgentService, mockApprovalService, mockBudgetService (+10 more)

### Community 1106 - "Community 1106"
Cohesion: 0.09
Nodes (10): BOOTSTRAP_SCRIPT_PATH, CompanyMember, CompanySummary, health, HumanUser, invitedUser, ownerUser, roleSelect (+2 more)

### Community 1107 - "Community 1107"
Cohesion: 0.10
Nodes (15): PaperclipIssueRuntimeReassignment, PaperclipIssueRuntimeSendOptions, container, firstMessages, firstOnSend, HookHarness(), messages, onSend (+7 more)
...
Cohesion: 0.10
Nodes (20): agents, default, directory, enabled, features, agentActivation, storyDrivenDevelopment, workflowAutomation (+12 more)

### Community 1110 - "Community 1110"
Cohesion: 0.10
Nodes (20): app, noCompanies, description, newCompany, title, sidebar, activity, company (+12 more)
...
Cohesion: 0.10
Nodes (11): FEATURE_CAPABILITIES, LAUNCHER_PLACEMENT_CAPABILITIES, OPERATION_CAPABILITIES, pluginCapabilityValidator, UI_SLOT_CAPABILITIES, CapabilityScopedInvoker, DEFAULT_GLOBALS, LoadedModule (+3 more)

### Community 1151 - "Community 1151"
Cohesion: 0.18
Nodes (18): composite(), contrastRatio(), DARK_BG, hexToRgb(), isDarkMode(), LIGHT_BG, pickTextColorForPillBg(), pickTextColorForSolidBg() (+10 more)

### Community 1152 - "Community 1152"
Cohesion: 0.18
Nodes (16): parseCommaArgs(), parseEnvBindings(), parseEnvVars(), parseJsonObject(), completed, entries, asNumber(), asString() (+8 more)
...
Cohesion: 0.10
Nodes (19): acceptInviteMock, approvalLinks, authForm, emailInput, existingAccountButton, getInviteMock, getSessionMock, healthGetMock (+11 more)

### Community 1155 - "Community 1155"
Cohesion: 0.22
Nodes (16): companies, findCompanyByPrefix(), getRememberedPathOwnerCompanyId(), GLOBAL_SEGMENTS, isRememberableCompanyPath(), sanitizeRememberedPathForCompany(), applyCompanyPrefix(), BOARD_ROUTE_ROOTS (+8 more)

### Community 1156 - "Community 1156"
Cohesion: 0.10
Nodes (18): c1, c2, child, child1, child2, { childMap }, globalIssue, grandchild (+10 more)

### Community 1157 - "Community 1157"
Cohesion: 0.10
Nodes (13): cloudHeaders, exportRequest, importRequest, mockAccessService, mockAgentService, mockBudgetService, mockCompanyPortabilityService, mockCompanyService (+5 more)

### Community 1158 - "Community 1158"
Cohesion: 0.10
Nodes (18): btn, desktopTargets, desktopViewport, __dirname, entry, mobileTargets, mobileViewport, outDir (+10 more)

### Community 1159 - "Community 1159"
Cohesion: 0.13
Nodes (10): getSandboxOrNull(), parseDriverConfig(), parseOptionalNumber(), parseOptionalString(), parseStringArray(), plugin, createModalClient(), isModalNotFound() (+2 more)

### Community 1160 - "Community 1160"
Cohesion: 0.10
Nodes (14): byPackageName, call, captured, cases, discovered, executeTool, getTool, jobStore (+6 more)

### Community 1161 - "Community 1161"
Cohesion: 0.16
Nodes (18): authPatch(), authPost(), extractAuthError(), request(), fetchNpmLatestVersion(), assert(), assertLocalSkillPackage(), createApiClient() (+10 more)

### Community 1162 - "Community 1162"
Cohesion: 0.11
Nodes (19): agentCount_one, agentCount_other, filters, live, live_withCount, newAgent, noAgents, noMatches (+11 more)
...
Cohesion: 0.11
Nodes (18): app, noCompanies, description, newCompany, title, roles, ceo, cfo (+10 more)
...
Cohesion: 0.11
Nodes (7): manifest, plugin, FakeDriverConfig, FakeLeaseState, leases, base, harness

### Community 1204 - "Community 1204"
Cohesion: 0.11
Nodes (15): ephemeral, reusable, sandbox, baseAcquireParams, baseConfig, baseConfigWithTokens, FakeProcess, FakeSandbox (+7 more)

### Community 1205 - "Community 1205"
Cohesion: 0.17
Nodes (15): readRuntimeServiceEntries(), buildWorkspaceCommandDefinition(), deriveWorkspaceCommandId(), findWorkspaceCommandDefinition(), listWorkspaceCommandDefinitions(), listWorkspaceServiceCommandDefinitions(), matchWorkspaceRuntimeServiceToCommand(), readCommandEntries() (+7 more)

### Community 1206 - "Community 1206"
Cohesion: 0.18
Nodes (17): buildExecutionWorkspaceAdapterConfig(), cloneRecord(), defaultIssueExecutionWorkspaceSettingsForProject(), gateProjectExecutionWorkspacePolicy(), issueExecutionWorkspaceModeForPersistedWorkspace(), ParsedExecutionWorkspaceMode, parseExecutionWorkspaceStrategy(), parseIssueExecutionWorkspaceSettings() (+9 more)

### Community 1207 - "Community 1207"
Cohesion: 0.17
Nodes (16): buildReleasePackagePlan(), checkConfiguration(), [command, arg], __dirname, getReleasePackages(), listPackages(), loadReleaseManifest(), manifestPath (+8 more)

### Community 1208 - "Community 1208"
Cohesion: 0.11
Nodes (11): decide, mockAccessService, mockAgentService, mockCompanyService, mockDocumentService, mockHeartbeatService, mockIssueRecoveryActionService, mockIssueService (+3 more)

### Community 1209 - "Community 1209"
Cohesion: 0.15
Nodes (16): deleteSelectedMentionChip(), findMentionLinkForDeletion(), findMentionLinkNode(), findMentionLinkNodeAtPoint(), handleMentionDelete(), isMentionLinkNode(), MentionDeletionDirection, mentionDeletionPlugin (+8 more)
...
Cohesion: 0.11
Nodes (17): buttons, clipboardWriteTextMock, copyLinkButton, createButton, createCompanyInviteMock, inviteHistory, inviteInput, invites (+9 more)

### Community 1212 - "Community 1212"
Cohesion: 0.14
Nodes (15): getCLIAdapter(), AdapterType, asErrorText(), asRecord(), HEARTBEAT_SOURCES, HEARTBEAT_TRIGGERS, heartbeatRun(), HeartbeatRunEventRecord (+7 more)
...
Cohesion: 0.11
Nodes (18): projects, addProject, myProjects, noProjects, otherProjects, projectCount_one, projectCount_other, selectCompany (+10 more)
...
Cohesion: 0.11
Nodes (16): existingRow, insertedRow, insertReturning, insertValues, selectFrom, selectWhere, svc, transaction (+8 more)

### Community 1254 - "Community 1254"
Cohesion: 0.18
Nodes (16): isMaxTurnExhaustionRun(), buildHeartbeatRunStopMetadata(), defaultTimeoutSecForAdapter(), hasOwn(), HeartbeatRunOutcome, HeartbeatRunStopMetadata, HeartbeatRunStopReason, HeartbeatRunTimeoutPolicy (+8 more)

### Community 1255 - "Community 1255"
Cohesion: 0.20
Nodes (18): clearIdleTimer(), ensureRuntimeServicesForRun(), markPersistedRuntimeServicesStoppedForExecutionWorkspace(), persistRuntimeServiceRecord(), readConfiguredServiceStates(), readDesiredRuntimeState(), registerRuntimeService(), releaseRuntimeServicesForRun() (+10 more)

### Community 1256 - "Community 1256"
Cohesion: 0.18
Nodes (15): bootstrapDevRunnerWorktreeEnv(), expandHomePrefix(), isLinkedGitWorktreeCheckout(), parseEnvFile(), repairStaleMigratedWorktreeEnvEntries(), resolveDefaultWorktreeHome(), resolveHomeAwarePath(), resolveWorktreeEnvFilePath() (+7 more)

### Community 1257 - "Community 1257"
Cohesion: 0.22
Nodes (16): __dirname, ensureNpmAuth(), formatCommand(), inspectNpmPackage(), main(), normalizePath(), parseArgs(), printNextSteps() (+8 more)

### Community 1258 - "Community 1258"
Cohesion: 0.17
Nodes (14): parseDriverConfig(), parseOptionalInteger(), parseOptionalString(), parseStringArray(), plugin, buildSshArgs(), buildSshDestination(), ExeDevDriverConfig (+6 more)
...
Cohesion: 0.12
Nodes (17): action, alphabeticalItem, browseLink, caret, currentRoot, flushReact(), newProjectButton, newProjectItem (+9 more)
...
Cohesion: 0.11
Nodes (16): archiveMemberMock, confirmButton, editButton, listAgentsMock, listIssuesMock, listJoinRequestsMock, listMembersMock, mockNavigate (+8 more)
...
Cohesion: 0.12
Nodes (17): attachmentLimit, brandColor, logo, error, hint, label, clear, hint (+9 more)
...
Cohesion: 0.19
Nodes (17): archiveSpace(), createSpace(), ensureDefaultSpace(), fallbackDefaultSpace(), listSpaces(), normalizePaperclipIngestionSourceScope(), normalizeSpaceSlug(), parseJsonObject() (+9 more)
...
Cohesion: 0.12
Nodes (12): adaptersIndex, hrefs, hybridPlugin, linearIndex, links, mockPluginsApi, pluginLinks, pluginsIndex (+4 more)

### Community 1441 - "Community 1441"
Cohesion: 0.15
Nodes (14): child, ignoreArgs, require, serverRoot, tsxCliPath, addIgnorePath(), resolveServerDevWatchIgnorePaths(), toGlobstarPath() (+6 more)

### Community 1442 - "Community 1442"
Cohesion: 0.12
Nodes (16): act(), [firstSegment, secondSegment], flushReact(), mockCompanyState, mockHealthApi, mockInstanceSettingsApi, mockNavigate, mockPluginSlotContexts (+8 more)
...
Cohesion: 0.15
Nodes (12): DevServerHealthStatus, describeReason(), DevRestartBanner(), formatRelativeTimestamp(), button, devServer, mockHealthApi, node (+4 more)

### Community 1445 - "Community 1445"
Cohesion: 0.12
Nodes (16): columns, concurrently, isUnique, method, name, with, approvals_company_status_type_idx, checkConstraints (+8 more)

### Community 1446 - "Community 1446"
Cohesion: 0.12
Nodes (16): columns, concurrently, isUnique, method, name, with, activity_log_company_created_idx, checkConstraints (+8 more)
...
Cohesion: 0.18
Nodes (12): manifest, plugin, harness, readOptionalString(), readString(), resolveDefaultBaseRef(), resolveProjectWorkspaceDefaultBaseRef(), workspaceDiffService() (+4 more)

### Community 1451 - "Community 1451"
Cohesion: 0.16
Nodes (13): BUILTIN_ROUTINE_VARIABLE_NAMES, getBuiltinRoutineVariableValues(), HUMAN_TIMESTAMP_FORMATTER, interpolateRoutineTemplate(), isBuiltinRoutineVariable(), isValidRoutineVariableName(), normalizeRoutineTemplateInput(), RoutineTemplateInput (+5 more)

### Community 1452 - "Community 1452"
Cohesion: 0.21
Nodes (13): findConfigFileFromAncestors(), resolvePaperclipConfigPath(), resolvePaperclipEnvPath(), ansi, color(), EmbeddedPostgresInfo, ExternalPostgresInfo, printStartupBanner() (+5 more)

### Community 1453 - "Community 1453"
Cohesion: 0.13
Nodes (14): AvailableBundledPlugin, PluginDashboardData, PluginDashboardJobRun, PluginDashboardWebhookDelivery, PluginHealthCheckResult, PluginLocalFolderProblem, PluginLocalFolderSaveInput, PluginLocalFoldersResponse (+6 more)

### Community 1454 - "Community 1454"
Cohesion: 0.13
Nodes (12): enabledDetailTabFilters, mockNavigate, mockPluginSlotMount, mockPluginSlotState, mockProjectsApi, mockRouteSearch, mockSetBreadcrumbs, mockSetSelectedCompanyId (+4 more)
...
Cohesion: 0.22
Nodes (14): base64UrlDecode(), base64UrlEncode(), createLocalAgentJwt(), jwtConfig(), JwtHeader, LocalAgentJwtClaims, parseJson(), parseNumber() (+6 more)

### Community 1459 - "Community 1459"
Cohesion: 0.12
Nodes (14): allDeps, allOptionalDeps, devPkgPath, __dirname, externalWorkspacePackages, outPath, pkg, pkgDirMap (+6 more)
...
Cohesion: 0.12
Nodes (14): backButton, clipboardWriteTextMock, closeNewAgentMock, createCompanyInviteMock, generateButton, getInviteOnboardingMock, inviteButton, listAdaptersMock (+6 more)

### Community 1462 - "Community 1462"
Cohesion: 0.12
Nodes (14): agentMap, baseTimestamps, codexAgent, comment, copyLink, copyText, detailsId, row (+6 more)

### Community 1463 - "Community 1463"
Cohesion: 0.12
Nodes (13): mockAgentsApi, mockAssetsApi, mockBudgetsApi, mockExecutionWorkspacesApi, mockHeartbeatsApi, mockInstanceSettingsApi, mockIssuesApi, mockIssuesList (+5 more)

### Community 1464 - "Community 1464"
Cohesion: 0.23
Nodes (9): parseJson(), pickToolUseId(), printAcpxStreamEvent(), statusLine(), stringify(), CapturedOutput, result, asNumber() (+1 more)

### Community 1465 - "Community 1465"
Cohesion: 0.14
Nodes (13): companyState, dialogState, flush(), input, mockAgentsApi, mockIssuesApi, mockProjectsApi, navigateState (+5 more)

### Community 1466 - "Community 1466"
Cohesion: 0.13
Nodes (15): sidebar, activity, company, costs, dashboard, goals, inbox, issues (+7 more)

### Community 1467 - "Community 1467"
Cohesion: 0.13
Nodes (9): manifest, plugin, harness, result, SmokeInput, SmokeSummary, agentId, companyId (+1 more)

### Community 1468 - "Community 1468"
Cohesion: 0.13
Nodes (12): dbMock, handoffActivityRow, issue, mockAccessService, mockFeedbackService, mockHeartbeatService, mockInstanceSettingsService, mockIssueService (+4 more)
...
Cohesion: 0.13
Nodes (11): args, argsCapturePath, authCheck, binDir, capture, cursorAgentPath, cursorHome, cwd (+3 more)

### Community 1471 - "Community 1471"
Cohesion: 0.13
Nodes (10): capture, capturePath, CapturePayload, commandPath, cursorAgentPath, customCommandPath, homeDir, remoteWorkspace (+2 more)
...
Cohesion: 0.14
Nodes (11): CachedViteHtmlRenderer, ViteWatcherEvent, ViteWatcherHost, WATCHER_EVENTS, indexPath, renderer, sourcePath, tempDir (+3 more)
...
Cohesion: 0.13
Nodes (10): queueContainedBlurCommit(), cancel, display, onCommit, onSave, outside, preview, root (+2 more)

### Community 1476 - "Community 1476"
Cohesion: 0.13
Nodes (13): editButton, mockAuthApi, mockLocation, mockNavigate, mockOpenOnboarding, mockSetSelectedCompanyId, mockSetSidebarOpen, mockSidebarPreferencesApi (+5 more)
...
Cohesion: 0.20
Nodes (12): boardMutationGuard(), DEFAULT_DEV_ORIGINS, isTrustedBoardMutationRequest(), parseOrigin(), SAFE_METHODS, trustedOriginsForRequest(), app, createApp() (+4 more)
...
Cohesion: 0.14
Nodes (10): archiveButton, BridgeGlobal, closeButton, confirm, consoleOutput, file, FileTreeNodeLike, FileTreePropsLike (+2 more)

### Community 1542 - "Community 1542"
Cohesion: 0.16
Nodes (11): WorkspaceDiffQueryOptions, WORKSPACE_DIFF_CAPS, byPath, createTempRepo(), execFileAsync, leak, runGit(), secretPath (+3 more)

### Community 1543 - "Community 1543"
Cohesion: 0.14
Nodes (13): bin, paperclip-plugin-dev-server, bugs, url, description, files, homepage, license (+5 more)

### Community 1544 - "Community 1544"
Cohesion: 0.15
Nodes (9): band, baseRetry, button, card, finalButton, getRetryNowButton(), retryNowMock, SYSTEM_NOW (+1 more)

### Community 1545 - "Community 1545"
Cohesion: 0.15
Nodes (12): buildSearchUrl(), agentsApiMock, breadcrumbState, companyState, dialogState, flush(), input, navigateMock (+4 more)

### Community 1546 - "Community 1546"
Cohesion: 0.14
Nodes (13): buildRequest(), mockActivityService, mockHeartbeatService, mockIssueService, requestApp(), requestApp(), requestApp(), requestApp() (+5 more)
...
Cohesion: 0.18
Nodes (6): getMentionAwareLinkNodeInit(), MentionAwareLinkNode, mentionAwareLinkNodeReplacement, MentionAwareLinkSource, editor, init
...
Cohesion: 0.27
Nodes (11): asRecord(), extractIssueTimelineEvents(), hasOwn(), IssueTimelineWorkspace, nullableString(), sameAssignee(), sameWorkspace(), sortTimelineEvents() (+3 more)

### Community 1551 - "Community 1551"
Cohesion: 0.19
Nodes (11): captureComposerViewportSnapshot(), ComposerViewportSnapshot, IssueChatScrollTarget, resolveIssueChatScrollTarget(), restoreComposerViewportSnapshot(), shouldPreserveComposerViewport(), composer, input (+3 more)

### Community 1552 - "Community 1552"
Cohesion: 0.15
Nodes (13): all, failedToApprove, failedToReject, noApprovalsYet, noPendingApprovals, pending, selectCompanyFirst, title (+5 more)

### Community 1553 - "Community 1553"
Cohesion: 0.15
Nodes (13): roles, ceo, cfo, cmo, cto, designer, devops, engineer (+5 more)
...
Cohesion: 0.35
Nodes (11): buildIssueReferenceHref(), extractIssueReferenceIdentifiers(), extractIssueReferenceMatches(), findIssueReferenceMatches(), IssueReferenceMatch, normalizeIssueIdentifier(), parseIssueReferenceHref(), preserveNewlinesAsWhitespace() (+3 more)
...
Cohesion: 0.17
Nodes (11): baseUrl, commitCount, markdownRows, numericMs(), scrollStartedAt, scrollTarget, startedAt, target (+3 more)
...
Cohesion: 0.15
Nodes (10): db, { db, limit }, liveRows, mockAgentService, mockHeartbeatService, mockInstanceSettingsService, mockIssueService, recentRows (+2 more)

### Community 1635 - "Community 1635"
Cohesion: 0.15
Nodes (11): baseUrl, ceoAgentAfterCreate, company, companyAfterAgent, desktopPlanningToggle, mobilePlanningToggle, openedIssueIdentifier, openedIssueUrl (+3 more)
...
Cohesion: 0.23
Nodes (12): getProjectOrderStorageKey(), getProjectSortModeStorageKey(), normalizeIdList(), normalizeSortMode(), ProjectOrderUpdatedDetail, ProjectSidebarSortMode, ProjectSortModeUpdatedDetail, readProjectOrder() (+4 more)
...
Cohesion: 0.17
Nodes (7): input, out, single, snapshot, TestIssue, WorkflowSortBlocker, WorkflowSortIssue

### Community 1641 - "Community 1641"
Cohesion: 0.24
Nodes (11): act(), bravoLink, chooseSortField(), flushReact(), hiddenDescriptionLine, mockOpenNewProject, mockProjectsApi, mockResourceMembershipsApi (+3 more)

### Community 1642 - "Community 1642"
Cohesion: 0.20
Nodes (10): createIssueRun(), createRun(), flushReact(), issueLink, mockHeartbeatsApi, mockIssuesApi, moreLink, queryClient (+2 more)

### Community 1643 - "Community 1643"
Cohesion: 0.33
Nodes (11): assertValidLocaleMessages(), formatPath(), hasBlockedData(), hasEventHandlerAttribute(), hasRawHtml(), interpolationPlaceholders(), isPlainObject(), urlsIn() (+3 more)

### Community 1644 - "Community 1644"
Cohesion: 0.24
Nodes (6): pluginEntities, adapterPreference(), declarationPatch(), fallbackAdapterType(), normalizeAdapterType(), selectPreferredAdapterType()

### Community 1645 - "Community 1645"
Cohesion: 0.17
Nodes (7): mockAccessService, mockFeedbackService, mockHeartbeatService, mockInstanceSettingsService, mockIssueService, mockIssueThreadInteractionService, mockLogActivity

### Community 1646 - "Community 1646"
Cohesion: 0.17
Nodes (9): mockAccessService, mockAgentService, mockExecutionWorkspaceService, mockFeedbackService, mockHeartbeatService, mockInstanceSettingsService, mockIssueService, mockLogActivity (+1 more)

### Community 1647 - "Community 1647"
Cohesion: 0.17
Nodes (9): mockAssertCanManageExecutionWorkspaceRuntimeServices, mockAssertCanManageProjectWorkspaceRuntimeServices, mockEnvironmentService, mockExecutionWorkspaceService, mockGetTelemetryClient, mockLogActivity, mockProjectService, mockSecretService (+1 more)
...
Cohesion: 0.17
Nodes (10): badges, issue, link, markReadButton, metaRow, root, state, statusIcon (+2 more)

### Community 1650 - "Community 1650"
Cohesion: 0.17
Nodes (10): createPayload, issue, mockAccessService, mockHeartbeatService, mockIssueApprovalService, mockIssueService, mockIssueThreadInteractionService, mockLogActivity (+2 more)

### Community 1651 - "Community 1651"
Cohesion: 0.17
Nodes (9): backlogBlocker, baseInput, baseReviewIssue, blocks, cancelled, cases, findings, manager (+1 more)
...
Cohesion: 0.18
Nodes (8): buildGapCandidates, buildGapPackages, fail(), listWorkspacePackages(), missingNames, packagesMissingTypecheck, repoRoot, workspacePackages

### Community 1654 - "Community 1654"
Cohesion: 0.29
Nodes (10): classifyNpmViewFailure(), collectReleasePackagesForChangedPaths(), getBaseReleaseState(), inspectNpmPackage(), main(), normalizePath(), readGitFileAtRevision(), baseReleaseState (+2 more)

### Community 1655 - "Community 1655"
Cohesion: 0.17
Nodes (11): agentNameInput, baseUrl, ceoAgent, ceoAgentAfterCreate, company, companyAfterAgent, companyNameInput, nextButton (+3 more)
...
Cohesion: 0.24
Nodes (9): i18nextOptions, reference, DEFAULT_LOCALE, i18nextResources, LOCALE_NAMES, localeMessages, localeModules, SupportedLocale (+1 more)

### Community 1659 - "Community 1659"
Cohesion: 0.18
Nodes (8): configPath, cwd, fixture, home, instanceRoot, ORIGINAL_CWD, ORIGINAL_ENV, raw

### Community 1660 - "Community 1660"
Cohesion: 0.18
Nodes (11): metrics, agentsDescription, agentsEnabled, awaitingReview, budgetOverrides, monthSpend, monthSpendDescription, pendingApprovals (+3 more)
...
Cohesion: 0.24
Nodes (7): ADAPTER_AGNOSTIC_KEYS, AgentConfigOverlay, AgentModelProfileOverlay, buildAgentUpdatePatch(), omitUndefinedEntries(), agent, patch
...
Cohesion: 0.24
Nodes (6): createCurrentRevisionSnapshot(), deriveDocumentRevisionState(), DocumentRevisionState, sortRevisionsDescending(), staleDocument, state

### Community 1702 - "Community 1702"
Cohesion: 0.20
Nodes (8): agents, card, flushReact(), listMock, navigateMock, orgMock, orgTree, renderOrgChart()
...
Cohesion: 0.33
Nodes (9): buildHeartbeatRunIssueComment(), mergeHeartbeatRunResultJson(), readCommentText(), readNumericField(), summarizeHeartbeatRunResultJson(), truncateSummaryText(), comment, merged (+1 more)
...
Cohesion: 0.18
Nodes (8): fetchMock, acquirePromise, body, child, firstSpawnArgs, MockChildProcess, spawnMock, sshCommand

### Community 1710 - "Community 1710"
Cohesion: 0.18
Nodes (8): commandPath, entries, envDumpPath, nonInjectedBinDir, nonInjectedSkillDir, skillBinDir, skillDir, workspace

### Community 1711 - "Community 1711"
Cohesion: 0.18
Nodes (8): agents, ceoAgent, companies, company, issue, issues, latestRun, runs
...
Cohesion: 0.24
Nodes (8): CompanySettingsNav(), CompanySettingsTab, getCompanySettingsTab(), items, button, navigateMock, pageTabBarMock, root
...
Cohesion: 0.22
Nodes (9): flushReact(), link, mockHeartbeatsApi, mockInstanceSettingsApi, renderSidebar(), sidebarSlot, topSearchLink, workLinks (+1 more)

### Community 1716 - "Community 1716"
Cohesion: 0.20
Nodes (9): containerDefinitions, cpu, executionRoleArn, family, memory, networkMode, requiresCompatibilities, taskRoleArn (+1 more)

### Community 1717 - "Community 1717"
Cohesion: 0.20
Nodes (9): folderTrust, enabled, hooks, AfterTool, BeforeAgent, BeforeTool, SessionEnd, SessionStart (+1 more)

### Community 1718 - "Community 1718"
Cohesion: 0.40
Nodes (8): createIssueLinkNode(), linkifyIssueReferencesInText(), MarkdownNode, parseIssuePathIdFromPath(), parseIssueReferenceFromHref(), remarkLinkIssueReferences(), rewriteMarkdownTree(), splitTrailingPunctuation()
...
Cohesion: 0.20
Nodes (10): columns, concurrently, isUnique, method, name, with, name, agent_task_sessions_company_agent_adapter_task_uniq (+2 more)
...
Cohesion: 0.20
Nodes (8): agentPolicy, cancelWorkForScope, dbStub, mockLogActivity, now, policy, SelectResult, service

### Community 1776 - "Community 1776"
Cohesion: 0.20
Nodes (8): company, mockAccessService, mockAgentService, mockBudgetService, mockCompanyPortabilityService, mockCompanyService, mockFeedbackService, mockLogActivity

### Community 1777 - "Community 1777"
Cohesion: 0.20
Nodes (8): mockEnvironmentService, mockGetTelemetryClient, mockGoalService, mockLogActivity, mockProjectService, mockSecretService, mockTelemetryTrack, mockWorkspaceOperationService

### Community 1778 - "Community 1778"
Cohesion: 0.20
Nodes (7): mockEnvironmentService, mockGetTelemetryClient, mockLogActivity, mockProjectService, mockSecretService, mockWorkspaceOperationService, normalizedEnv
...
Cohesion: 0.20
Nodes (7): agentId, blockedIssueId, blockerIssueId, checkedOutIssueId, companyId, harness, runId

### Community 1781 - "Community 1781"
Cohesion: 0.22
Nodes (6): declaration, flushReact(), link, mockPluginsApi, mockSetBreadcrumbs, renderSettings()

### Community 1782 - "Community 1782"
Cohesion: 0.22
Nodes (9): resolveExecutionRunAdapterConfig(), stripPaperclipRuntimeEnvBindings(), stripPaperclipRuntimeEnvFromAdapterConfig(), browserHref, originalConfig, releaseHref, resolveAdapterConfigForRuntime, resolveEnvBindings (+1 more)
...
Cohesion: 0.24
Nodes (9): allOutputsExist(), buildTargets, lockDir, result, rootDir, scriptDir, sleep(), tscCliPath (+1 more)
...
Cohesion: 0.20
Nodes (8): cleanupDirs, customSkill, moduleDir, optionalDir, requiredDir, runtimeSkill, skillsHome, staleMaintainerSkill

### Community 1790 - "Community 1790"
Cohesion: 0.20
Nodes (7): db, existingRow, interactionRow, mockCreateChild, SelectRow, state, svc

### Community 1791 - "Community 1791"
Cohesion: 0.22
Nodes (10): buildLoginShellScript(), isValidShellEnvKey(), shellQuote(), buildCreateCommand(), buildEnvFlags(), buildFlag(), buildRepeatedFlag(), redactCreateCommand() (+2 more)

### Community 1792 - "Community 1792"
Cohesion: 0.20
Nodes (8): auth, callInit, creds, jwtPayload, labels, mockResponse, promise, snapshot
...
Cohesion: 0.29
Nodes (8): calls, fetchImpl(), file, FetchLike, IngestSourceActionResult, readIngestOperationIssueId(), readUploadError(), uploadIssueAttachmentFile()
...
Cohesion: 0.25
Nodes (7): boardMember, createCompanyViaWizard(), ensureBootstrapped(), humanOption, inviteButton, nonOwner, roleSelect
...
Cohesion: 0.22
Nodes (6): ApprovalRecord, approved, dbStub, mockAgentService, mockNotifyHireApproved, svc

### Community 1806 - "Community 1806"
Cohesion: 0.22
Nodes (5): companyBranding, invite, logoAsset, mockStorage, reusableJoinRequest
...
Cohesion: 0.28
Nodes (7): startLocksByAgent, waitForAgentStartLock(), withAgentStartLock(), agentId, firstStart, secondStart, secondStartResult

### Community 1810 - "Community 1810"
Cohesion: 0.25
Nodes (3): resolveDefaultConfigPath(), resolveManagedProjectWorkspaceDir(), sanitizeFriendlyPathSegment()
...
Cohesion: 0.22
Nodes (6): capture, capturePath, CapturePayload, commandPath, promptFlagIndex, workspace
...
Cohesion: 0.25
Nodes (4): manifest, plugin, looksLikePath(), sanitizeWorkspacePath()
...
Cohesion: 0.22
Nodes (6): mockInstanceSettingsApi, mockSidebarBadgesApi, mockUsePluginSlots, queryClient, root, sidebarNavItemMock

### Community 1820 - "Community 1820"
Cohesion: 0.22
Nodes (7): avatarInput, file, mockAssetsApi, mockAuthApi, mockSetBreadcrumbs, queryClient, root

### Community 1821 - "Community 1821"
Cohesion: 0.25
Nodes (7): endedAt, files, filesModified, provider, sessionId, startedAt, toolExecutions
...
Cohesion: 0.25
Nodes (6): CI_ENV_VARS, client, configPath, ORIGINAL_ENV, root, statePath

### Community 1826 - "Community 1826"
Cohesion: 0.25
Nodes (7): __liveUpdatesTestUtils, cache, { getCommentMock }, invalidated, invalidations, queryClient, setCalls

### Community 1827 - "Community 1827"
Cohesion: 0.46
Nodes (7): getWorktreeUiBranding(), hexToRgb(), normalizeHexColor(), pickReadableTextColor(), readMetaContent(), relativeLuminanceChannel(), WorktreeUiBranding

### Community 1828 - "Community 1828"
Cohesion: 0.25
Nodes (8): general, hint, label, placeholder, description, name, hint, label
...
Cohesion: 0.25
Nodes (7): alternateWorkspaceDir, call, cleanupDirs, dir, {
  runChildProcess,
  ensureCommandResolvable,
  resolveCommandForLogs,
  prepareWorkspaceForSshExecution,
  ...
  syncDirectoryToSsh,
  startAdapterExecutionTargetPaperclipBridge,
}, workspaceDir, command

### Community 1868 - "Community 1868"
Cohesion: 0.25
Nodes (6): db, invite, mockAccessService, mockAgentService, mockBoardAuthService, mockLogActivity

### Community 1869 - "Community 1869"
Cohesion: 0.25
Nodes (6): mockAccessService, mockAgentService, mockCompanySkillService, mockGetTelemetryClient, mockLogActivity, mockTrackSkillImported

### Community 1870 - "Community 1870"
Cohesion: 0.25
Nodes (5): existing, mockHeartbeatService, mockIssueService, mockIssueThreadInteractionService, updated

### Community 1871 - "Community 1871"
Cohesion: 0.25
Nodes (5): manifest, plugin, harness, action, data
...
Cohesion: 0.39
Nodes (6): buildInitialExportCheckedFiles(), buildRecurringTaskPrefixes(), isRecurringTaskFile(), isTaskPath(), checked, CompanyPortabilityIssueManifestEntry

### Community 1874 - "Community 1874"
Cohesion: 0.25
Nodes (6): apiRoutes, conflict, mockIssueService, mockLifecycle, mockRegistry, result

### Community 1875 - "Community 1875"
Cohesion: 0.25
Nodes (7): BASE_PARAMS, driver, errorEvent, execs, FAKE_MANIFEST, harness, realize
...
Cohesion: 0.32
Nodes (6): createCapturedOutputBuffer(), normalizeByteLimit(), parseJsonResponseWithLimit(), capture, response, result
...
Cohesion: 0.25
Nodes (6): en, enPath, filePath, files, localeData, mergedData
...
Cohesion: 0.25
Nodes (5): cleanupDirs, existingTarget, injectedA, injectedB, logs

### Community 1887 - "Community 1887"
Cohesion: 0.25
Nodes (5): args, argsCapturePath, binDir, cwd, root

### Community 1888 - "Community 1888"
Cohesion: 0.25
Nodes (7): addr, listeningAddress, require, SupertestServer, SupertestTest, SupertestTestConstructor, SupertestTestInstance
...
Cohesion: 0.32
Nodes (6): scheduleMainContentFocus(), shouldFocusMainContentAfterNavigation(), input, main, sidebarButton, staleButton
...
Cohesion: 0.29
Nodes (6): __dirname, externals, externalWorkspacePackages, pkg, repoRoot, workspacePaths
...
Cohesion: 0.29
Nodes (7): presets, 30d, 7d, all, custom, mtd, ytd
...
Cohesion: 0.29
Nodes (6): engines, node, name, packageManager, private, type

### Community 1940 - "Community 1940"
Cohesion: 0.48
Nodes (4): printGrokStreamEvent(), spy, asRecord(), asString()

### Community 1941 - "Community 1941"
Cohesion: 0.29
Nodes (5): mockApprovalService, mockHeartbeatService, mockIssueApprovalService, mockLogActivity, mockSecretService

### Community 1942 - "Community 1942"
Cohesion: 0.29
Nodes (4): mockAgentService, mockGetTelemetryClient, mockIssueService, mockTrackAgentTaskCompleted

### Community 1943 - "Community 1943"
Cohesion: 0.29
Nodes (4): mockHeartbeatService, mockInteractionService, mockIssueService, mockLogActivity
...
Cohesion: 0.33
Nodes (3): GroupedSource, IssueRelatedWorkPanel(), html
...
Cohesion: 0.29
Nodes (6): binDir, codexHome, cwd, fakeCodex, root, script

### Community 1954 - "Community 1954"
Cohesion: 0.29
Nodes (3): cleanupDirs, logs, staleTarget

### Community 1955 - "Community 1955"
Cohesion: 0.29
Nodes (4): cleanupDirs, clearedCtx, configuredCtx, ctx
...
Cohesion: 0.38
Nodes (7): ensureRemoteWorkspace(), buildLease(), detectRemoteContext(), formatSshFailure(), prepareSshIdentity(), runSshCommand(), tmpDir

### Community 1958 - "Community 1958"
Cohesion: 0.38
Nodes (7): resolveApiKey(), buildVmName(), createVm(), deleteVm(), lookupVm(), parseVmRecord(), runLifecycleCommand()

### Community 1959 - "Community 1959"
Cohesion: 0.33
Nodes (5): flushReact(), mockParams, mockPluginsApi, mockSetBreadcrumbs, renderPage()

### Community 1960 - "Community 1960"
Cohesion: 0.29
Nodes (5): mockAccessApi, mockAuthApi, mockHealthApi, queryClient, root
...
Cohesion: 0.60
Nodes (4): isAuthorizedRequest(), readBearerToken(), request, timingSafeStringEqual()
...
Cohesion: 0.47
Nodes (4): buildDocumentAnnotationHash(), DocumentAnnotationHashTarget, parseDocumentAnnotationHash(), target

### Community 1970 - "Community 1970"
Cohesion: 0.33
Nodes (6): default, name, notNull, primaryKey, type, adapter_config
...
Cohesion: 0.33
Nodes (6): default, name, notNull, primaryKey, type, coalesced_count
...
Cohesion: 0.33
Nodes (6): total_output_tokens, default, name, notNull, primaryKey, type

### Community 1977 - "Community 1977"
Cohesion: 0.33
Nodes (6): default, name, notNull, primaryKey, type, actor_type
...
Cohesion: 0.33
Nodes (6): total_cached_input_tokens, default, name, notNull, primaryKey, type

### Community 1980 - "Community 1980"
Cohesion: 0.33
Nodes (6): total_input_tokens, default, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): total_cost_cents, default, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): state_json, default, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): devDependencies, cross-env, esbuild, @playwright/test, typescript, vitest
...
Cohesion: 0.33
Nodes (4): copyButton, handoff, root, scrollIntoView
...
Cohesion: 0.33
Nodes (5): playwrightPkgRoot, repoRoot, stories, target, themes
...
Cohesion: 0.33
Nodes (4): lines, parsed, spy, stdout
...
Cohesion: 0.33
Nodes (5): fmtSgt, fmtUtc, mockPino, mockTransport, { targets }

### Community 2167 - "Community 2167"
Cohesion: 0.33
Nodes (5): cwd, fakeOpencode, missingCheck, modelCheck, script
...
Cohesion: 0.33
Nodes (4): binDir, cwd, root, stalePackageCheck
...
Cohesion: 0.40
Nodes (4): act(), onLeave, parentClick, renderAction()
...
Cohesion: 0.40
Nodes (5): company_id, name, notNull, primaryKey, type

### Community 2182 - "Community 2182"
Cohesion: 0.40
Nodes (5): trigger_detail, name, notNull, primaryKey, type

### Community 2183 - "Community 2183"
Cohesion: 0.40
Nodes (5): last_run_id, name, notNull, primaryKey, type

### Community 2184 - "Community 2184"
Cohesion: 0.40
Nodes (5): payload, name, notNull, primaryKey, type
...
Cohesion: 0.40
Nodes (5): source, name, notNull, primaryKey, type
...
Cohesion: 0.40
Nodes (5): last_error, name, notNull, primaryKey, type

### Community 2196 - "Community 2196"
Cohesion: 0.40
Nodes (5): requested_by_actor_id, name, notNull, primaryKey, type

### Community 2197 - "Community 2197"
Cohesion: 0.40
Nodes (5): requested_by_actor_type, name, notNull, primaryKey, type

### Community 2198 - "Community 2198"
Cohesion: 0.40
Nodes (5): rollup, embedded-postgres@18.1.0-beta.16, pnpm, overrides, patchedDependencies

### Community 2200 - "Community 2200"
Cohesion: 0.40
Nodes (5): last_run_status, name, notNull, primaryKey, type
...
Cohesion: 0.40
Nodes (3): agents, companies, dbStub

### Community 2210 - "Community 2210"
Cohesion: 0.40
Nodes (5): buildLoginShellScript(), ensureRemoteWorkspace(), isValidShellEnvKey(), shellQuote(), deleteStdinPath()

### Community 2211 - "Community 2211"
Cohesion: 0.50
Nodes (3): analyzeLocales(), countKeys(), outputFile
...
Cohesion: 0.40
Nodes (4): codes, cwd, executeCalls, probeCall

### Community 2214 - "Community 2214"
Cohesion: 0.40
Nodes (3): cleanupDirs, configuredCtx, ctx

### Community 2215 - "Community 2215"
Cohesion: 0.40
Nodes (3): parsed, spy, stdout

### Community 2216 - "Community 2216"
Cohesion: 0.83
Nodes (3): SessionStart.sh script, check_mcp_docker(), check_mcp_tcp()
...
Cohesion: 0.50
Nodes (4): collectMatchedParentDirs(), discoverPublicPackages(), walk(), agentInstructionFiles()
...
Cohesion: 0.50
Nodes (3): html, manifest, uiRoot

### Community 2242 - "Community 2242"
Cohesion: 0.67
Nodes (3): formatErrorMessage(), buildSandboxCreateParams(), createSandboxFor()

### Community 2243 - "Community 2243"
Cohesion: 0.67
Nodes (3): dependencies, @paperclipai/shared, zod
...
## Knowledge Gaps
- **39092 isolated node(s):** `extends`, `files`, `references`, `name`, `private` (+39087 more)
...
- **Why does `runDatabaseRestore()` connect `Community 58` to `Community 17`, `Community 10`, `Community 1460`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `basename()` connect `Community 1460` to `Community 24`, `Community 58`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `pages` connect `Community 1564` to `Community 65`, `Community 611`, `Community 1220`, `Community 521`, `Community 1168`, `Community 1169`, `Community 567`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `extends`, `files`, `references` to the rest of the system?**
  _39152 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.007850428674723686 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.013556967272808758 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.01085960283293987 - nodes in this community are weakly interconnected._