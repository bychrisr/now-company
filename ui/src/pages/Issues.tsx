...
export function Issues() {
  ...
  const issueLinkState = useMemo(
    () =>
      createIssueDetailLocationState(
        t("pages.issues.title", { defaultValue: "Issues" }),
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.issues.title", { defaultValue: "Issues" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={CircleDot} message={t("pages.issues.selectCompany", { defaultValue: "Select a company to view issues." })} />;
  }
